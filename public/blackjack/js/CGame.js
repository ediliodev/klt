function CGame(oData){
    ...
    this._init = function(){
        ...
        var lpay = 0;
        //lpay tiene cero default pero su valor se consulta en cookies o localstorage later ok ted here.
        var mensajito = TEXT_DISPLAY_MSG_SIT_DOWN + ". Ult. pago: " + lpay;
        _oInterface.displayMsg(mensajito);
    ...
    this.setMoney = function(iMoney){
        _oSeat.setVisibleSitDownButton(false);
         _oSeat.setCredit(iMoney);  //modificado ted, incremetar mejor abajo ok
       // _oSeat.increaseCredit(iMoney);
    ...
    this.subirMoney = function(iMoney){
        _oSeat.setVisibleSitDownButton(false);
         _oSeat.increaseCredit(iMoney);  //modificado ted, incremetar mejor abajo ok
       // _oSeat.increaseCredit(iMoney);
     ...
     this.leerMoney = function(){
        
      //  var valor = _oSeat.getCredit());
      //  return valor;
