function CInterface(iMoney){
	...
	var doc = window.document;
        ...
        _oCobrarBut  = new CTextButton(1408,CANVAS_HEIGHT -30,oSprite,"COBRAR",FONT_GAME_1,"#ffffff",20,s_oStage);
        _oCobrarBut.addEventListener(ON_MOUSE_UP, this._onButCobrarRelease, this);
    ...
    this._onButCobrarRelease = function(){
        this.disableButtons();
        s_oGame.clearBets();
        s_oGame.onExit();  // ok ted
